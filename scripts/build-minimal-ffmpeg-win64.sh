...
if [ ! -x "$dist/bin/ffmpeg.exe" ]; then
  ...
  ( cd "$src/ffmpeg"
    ...
    if ! ./configure \
      ...
      --extra-cxxflags="-D__MINGW_CXX11_CONSTEXPR=constexpr -D__MINGW_CXX14_CONSTEXPR=constexpr -I$mingw_headers -I$deps/zlib/include -I$deps/x264/include -I$deps/lame/include -I$deps/dav1d/include -I$deps/nv/include -I$deps/amf/include -I$deps/libvpl/include" \
